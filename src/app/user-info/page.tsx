...
import useSafeOnClickOutside from '@/hooks/useSafeOnClickOutside';
...
export default function UserInfoPage() {
  ...
  const locationRef = useSafeOnClickOutside(() => {
    clearSuggestions();
  });
  ...
  const handleLocationSelect = (description: string) => async () => {
          ...
          <form onSubmit={handleSubmit}>
            ...
            <FormControl fullWidth>
              ...
              >
                ...
                {[
                  'Allergies or Immune Deficiencies',
                  'Autoimmune Diseases',
                  ...
                  'Eating Disorders',
                  'Elderly Individuals (General Aging)',
                  'Genetic Disorders',
                  ...
                  'Sex/Gender-Related Health Needs',
                  'Sleep Disorders',
                  'Substance Abuse Issues',
                  'Terminal Illnesses',
                  'Traumatic Injuries',
                  'Vision or Hearing Loss (Age-Related)',
                ].map((condition) => (
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        ...
                        onChange={() => {
                          handleArrayChange('challenges', challenge);
                        }}
                      />
                    }
                    label={challenge}
